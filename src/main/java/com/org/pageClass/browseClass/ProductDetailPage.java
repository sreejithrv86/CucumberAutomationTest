package com.org.pageClass.browseClass;

import org.openqa.selenium.WebDriver;
import org.openqa.selenium.WebElement;
import org.openqa.selenium.support.FindBy;
import org.openqa.selenium.support.PageFactory;
import com.org.utilityClass.Wait;
...
public class ProductDetailPage {
    ...
    public boolean defaultProductDetailPageIsDisplayed() {
        Wait.untilAjaxCallIsDone(webDriver, Duration.ofSeconds(10));
    ...
    public boolean nonFisikProductDetailDataIsDisplayed() {
        Wait.untilElementIsVisible(webDriver, starProductDetail, Duration.ofSeconds(8));
